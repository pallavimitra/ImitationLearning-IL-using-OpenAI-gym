...
def Load_and_Wrangle():
    ...
    #Y2 = np.delete(Y2, -1, 0)
        ...
        for i in range(1, NumberOfFolders):
            Tar = pd.read_csv(DataPath+'/CarRacing_ActionsRewards.csv')
        ...
        if (RBG_Mode == False or ConvFolder2Gray == True):
            if Temporal_Buffer > 1:
                ...
                for i in range(T_len[0]):
                    ...
                    if ConvFolder2Gray == True:
                        Img_tmp = CarConfig.rgb2gray(imageio.imread(DataPath+"/Img"+str(i)+".png"))
                    else:
                        Img_tmp = imageio.imread(DataPath+"/Img"+str(i)+".png")
                    if Buf != 0:
                        X[ctr,Buf,:,:,0] = Img_tmp
                    else:
                        ctr = min(ctr+1, size-1)
                ...
                for i in range(T_len[0]):
                    if ConvFolder2Gray == False:
                        X[i,:,:,0] = imageio.imread(DataPath+"/Img"+str(i)+".png")
                    else:
                        Xrgb = imageio.imread(DataPath+"/Img"+str(i)+".png")
            ...
            if Temporal_Buffer > 1:
                ...
                for i in range(T_len[0]):
                    X[i,:,:,:] = imageio.imread(DataPath+"/Img"+str(i)+".png")
                ...
                if (RBG_Mode == False or ConvFolder2Gray == True):
                    if Temporal_Buffer > 1:
                        ...
                        for i in range(T_len[j]):
                            Buf = i % Temporal_Buffer
                            if ConvFolder2Gray == True:
                                Img_tmp = CarConfig.rgb2gray(imageio.imread(DataPath+str(j)+"/Img"+str(i)+".png"))
                            else:
                                Img_tmp = imageio.imread(DataPath+str(j)+"/Img"+str(i)+".png")
                            if Buf != 0:
                        ...
                        for i in range(T_len[j]):
                            if ConvFolder2Gray == False:
                                X_t[i,:,:,0] = imageio.imread(DataPath+str(j)+"/Img"+str(i)+".png")
                            else:
                                Xrgb = imageio.imread(DataPath+str(j)+"/Img"+str(i)+".png")
                    ...
                    if Temporal_Buffer > 1:
                        ...
                        for i in range(T_len[j]):
                            X_t[i,:,:,:] = imageio.imread(DataPath+str(j)+"/Img"+str(i)+".png")
